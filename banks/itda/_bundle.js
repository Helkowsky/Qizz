   ...
   "questions": [
    ...
    },
    {
     ...
     "explications": [
      ...
      "Faux selon le corrigé retenu : un regroupement en trois phases (planification → stratégie/évaluation des risques → appréciation) existe dans certains supports, mais le corrigé retient quatre phases en isolant l'évaluation de l'efficacité comme phase propre.",
      "Bonne réponse (corrigé retenu) : quatre phases — planification/identification des risques ; stratégie & évaluation des risques ; évaluation de l'efficacité ; appréciation globale/conclusion. Attention : le modèle compte 6-7 ÉTAPES regroupées en phases ; ne pas confondre étapes et phases.",
